...
class TechnologyFragment : Fragment(), RecyclerViewClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setRecyclerData()
        flTech.visibility = View.VISIBLE
        callAutoApi()
    ...
    private fun callAutoApi() {
        ...
        val call = autoClient.getNewsAllMainData(technology)
        call.enqueue(object : Callback<ResponseModel> {
            override fun onResponse(call: Call<ResponseModel>, response: Response<ResponseModel>) {
                response.body().let {
                    flTech.visibility = View.GONE
