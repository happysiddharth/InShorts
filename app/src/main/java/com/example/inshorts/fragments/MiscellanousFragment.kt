...
import kotlinx.android.synthetic.main.fragment_miscellanous.*
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class MiscellanousFragment : Fragment(), RecyclerViewClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_miscellanous, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setRecyclerData()
        flMiscellaneous.visibility = View.VISIBLE
        callAutoApi()
    ...
    private fun callAutoApi() {
        ...
        val call = autoClient.getNewsAllMainData(miscellaneous)
        call.enqueue(object : Callback<ResponseModel> {
            override fun onResponse(call: Call<ResponseModel>, response: Response<ResponseModel>) {
                response.body().let {
                    flMiscellaneous.visibility = View.GONE
