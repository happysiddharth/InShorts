...
class EntertainmentFragment : Fragment(), RecyclerViewClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setRecyclerData()
        flEntertainment.visibility = View.VISIBLE
        callAutoApi()
    }
    ...
    private fun callAutoApi() {
        ...
        val call = autoClient.getNewsAllMainData(entertainment)
        call.enqueue(object : Callback<ResponseModel> {
            override fun onResponse(call: Call<ResponseModel>, response: Response<ResponseModel>) {
                response.body().let {
                    flEntertainment.visibility = View.GONE
